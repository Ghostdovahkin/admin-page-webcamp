      ...
      <div class="col-xs-12">
        <div class="box">
          <div class="box-header">
            <h3 class="box-title">Aquí podras borrar o editar eventos</h3>
          </div>
          <!-- /.box-header -->
          <div class="box-body">
                        ...
                        while($eventos = $resultado->fetch_assoc() ) { ?>
                            <tr>
                                ...
                                <td>
                                        ...
                                        <a href="#" data-id="<?php echo $eventos['evento_id']; ?>" data-tipo="eventos" type="button" class="btn bg-maroon btn-flat margin borrar_registro"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                </td>
                            </tr>
                        <?php } ?>
